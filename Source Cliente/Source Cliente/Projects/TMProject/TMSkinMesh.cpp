...
void TMSkinMesh::FrameMove(unsigned int dwServerTime)
{
	...
	int nCostype = m_nCosType;
	int Mesh = nCostype + 77;
	int CosOne = 4164 + nCostype;
...
void TMSkinMesh::SetCostume(int Costype, char* szTexture, char* szName)
{
	...
	if (nCostype > 41) {
		if (CosOne == 4206) {
			Mesh = 120;
			strcpy(szTexture, strFmt("mesh\\ch0101%d.wys", Mesh));
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, strFmt("mesh\\ch0101%d.msh", Mesh));
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, strFmt("mesh\\ch0102%d.msh", Mesh));
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, strFmt("mesh\\ch0103%d.msh", Mesh));
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, strFmt("mesh\\ch0104%d.msh", Mesh));
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, strFmt("mesh\\ch0105%d.msh", Mesh));
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, strFmt("mesh\\ch0106%d.msh", Mesh));
				m_Cos = 1;
				break;
			}
		}
		...
		if (CosOne == 4215) {
			Mesh = 140;
			strcpy(szTexture, strFmt("mesh\\ch0101140Orage.wyt", Mesh));
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, strFmt("mesh\\ch0101%d.msh", Mesh));
		...
		if (CosOne == 4218) {
			Mesh = 141;
			strcpy(szTexture, strFmt("mesh\\ch0101%dred.wys", Mesh));
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, strFmt("mesh\\ch0101%d.msh", Mesh));
		...
		if (CosOne == 4220) {
			Mesh = 140;
			strcpy(szTexture, strFmt("mesh\\ch0101140LavaR.wyt"));
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, strFmt("mesh\\ch0101%d.msh", Mesh));
		...
		if (CosOne == 4221) {
			Mesh = 164;
			strcpy(szTexture, strFmt("mesh\\ch0101%dblue.wys", Mesh));
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, strFmt("mesh\\ch0101%d.msh", Mesh));
		...
		if (CosOne == 4231) {
			Mesh = 100;
			strcpy(szTexture, strFmt("mesh\\ch0201%d.wys", Mesh));
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, strFmt("mesh\\ch0201%d.msh", Mesh));
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, strFmt("mesh\\ch0202%d.msh", Mesh));
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, strFmt("mesh\\ch0203%d.msh", Mesh));
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, strFmt("mesh\\ch0204%d.msh", Mesh));
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, strFmt("mesh\\ch0205%d.msh", Mesh));
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, strFmt("mesh\\ch0206%d.msh", Mesh));
				m_Cos = 1;
				break;
			}
		}
	...
	else if (nCostype >= 34 && nCostype <= 41)
	{
		strcpy(szTexture, strFmt("mesh\\ch0101%d.wys", Mesh));
		switch (m_Cos)
		{
