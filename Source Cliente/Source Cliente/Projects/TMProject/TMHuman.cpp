...
int TMHuman::InitObject()
{
    ...
    int nCos = 0;
    if (m_sCostume >= 4150 && m_sCostume < 4467 || m_sCostume >= 6301 && m_sCostume <= 6400 && m_nClass != 29)
    {
...
int TMHuman::OnPacketUpdateEtc(MSG_STANDARD* pStd)
{
    ...
    if (g_pCurrentScene->m_pMyHuman == this)
    {
        ...
        {
            char szTmp2[10]{};
            sprintf(szTmp2, "%d", pUpdateEtc->Cash);
            static_cast<TMFieldScene*>(g_pCurrentScene)->m_pCash->SetText(szTmp2, 0);
...
int TMHuman::OnPacketTrade(MSG_Trade* pStd)
{
    ...
    if (g_pObjectManager->m_stTrade.OpponentID || !pStd->OpponentID)
    {
        ...
        if (!pScene->m_pControlContainer->FindControl(576)->IsVisible())
        {
            ...
            {
                char szMyName[128]{};
                sprintf(szMyName, "[%s]", m_szName);
                char szOPName[128]{};
                sprintf(szOPName, "[%s]", pNode->m_szName);
    ...
    if (!m_dwDelayDel)
    {
        ...
        if(pDest == nullptr)
        {
            ...
            if (m_pNickNameLabel)
            {
                ...
                if (!strcmp(m_szNickName, "Torne-se Cidadão"))
                ...
                else if (!strcmp(m_szNickName, "Passar Add Armadura Arch"))
                    m_pNickNameLabel->SetTextColor(TNColor::DeepPink);
                    ...
                    m_pNickNameLabel->SetTextColor(TNColor::CornBlue);
                else if (!strcmp(m_szNickName, "Esfera M"))
                    m_pNickNameLabel->SetTextColor(TNColor::Default);
                else if (!strcmp(m_szNickName, "Esfera A"))
                    m_pNickNameLabel->SetTextColor(TNColor::Default);
                    ...
                    m_pNickNameLabel->SetTextColor(TNColor::CornBlue);
                else if (!strcmp(m_szNickName, "Reset Skill"))
                    m_pNickNameLabel->SetTextColor(TNColor::CornBlue);
                else if (!strcmp(m_szNickName, "Teleport"))
                    m_pNickNameLabel->SetTextColor(TNColor::Speak);
                else if (!strcmp(m_szNickName, "Comerciante"))
                    m_pNickNameLabel->SetTextColor(TNColor::CornBlue);
                else if (!strcmp(m_szNickName, "Add Arma Arch"))
                    m_pNickNameLabel->SetTextColor(TNColor::DarkOrange);
                else if (!strcmp(m_szNickName, "Compositor Diverso"))
                    m_pNickNameLabel->SetTextColor(TNColor::Default);
                else if (!strcmp(m_szNickName, "Reviver Montarias"))
                    m_pNickNameLabel->SetTextColor(TNColor::Default);
                else if (!strcmp(m_szNickName, "Quest Amuleto"))
                    m_pNickNameLabel->SetTextColor(TNColor::Default);
                else if (!strcmp(m_szNickName, "Aprender Skill"))
                    m_pNickNameLabel->SetTextColor(TNColor::CornBlue);
...
void TMHuman::SetPacketEquipItem(unsigned short* sEquip)
{
    if (!m_dwDelayDel)
    {
        ...
        if ((int)sEquip[12] < 4150 || (int)sEquip[12] > 4467)
            m_sCostume = 0;
        else
...
void  TMHuman::SetMountCostume(unsigned int  index)
{
    ...
    if (index >= 11 && index <= 200 && (!(m_stScore.Reserved & 2)))
    {
        ...
        case 26:
            m_fMountScale = 1.0f;
            m_stMountLook.Mesh0 = 22;
            m_nMountSkinMeshType = 31;
            m_stMountLook.Mesh1 = 22;
            m_stMountSanc.Sanc2 = 12;
            m_stMountSanc.Sanc1 = 12;
            m_stMountSanc.Sanc0 = 12;
            m_stOldMountSanc.Sanc2 = 12;
        ...
        case 28:
            ...
            break;
        case 29:
            m_stMountLook.Mesh0 = 23;
            m_stMountLook.Mesh1 = 23;
            m_fMountScale = 1.0f;
            m_nMountSkinMeshType = 31;
            m_stMountSanc.Sanc2 = 12;
            m_stMountSanc.Sanc1 = 12;
            ...
            break;
        case 30:
            m_stMountLook.Mesh0 = 24;
            m_stMountLook.Mesh1 = 24;
            m_fMountScale = 1.0f;
            m_nMountSkinMeshType = 31;
            m_stMountSanc.Sanc2 = 12;
            m_stMountSanc.Sanc1 = 12;
            ...
            break;
        case 31:
            m_stMountLook.Mesh0 = 25;
            m_stMountLook.Mesh1 = 25;
            m_fMountScale = 1.0f;
            m_nMountSkinMeshType = 31;
            m_stMountSanc.Sanc2 = 12;
            m_stMountSanc.Sanc1 = 12;
            ...
            break;
        case 32:
            m_stMountLook.Mesh0 = 26;
            m_stMountLook.Mesh1 = 26;
            m_fMountScale = 1.0f;
            m_nMountSkinMeshType = 31;
            m_stMountSanc.Sanc2 = 12;
            m_stMountSanc.Sanc1 = 12;
        ...
        case 33:
            ...
            break;
        case 34:
            m_stMountLook.Mesh0 = 27;
            m_stMountLook.Mesh1 = 27;
            m_fMountScale = 1.0f;
            m_nMountSkinMeshType = 31;
            m_stMountSanc.Sanc2 = 12;
            m_stMountSanc.Sanc1 = 12;
        ...
        case 36:
            ...
            m_stMountSanc.Sanc0 = 0;
            m_stOldMountSanc.Sanc2 = 0;
            m_stOldMountSanc.Sanc1 = 0;
            m_stOldMountSanc.Sanc0 = 0;
            break;
        case 37:
...
int TMHuman::SetHumanCostume()
{
    ...
    if (m_sCostume >= 4200 && m_sCostume <= 4467)
    {
        memset(&m_stSancInfo.Sanc0, 13, 6u);
        memset(&m_stSancInfo.Legend0, 13, 6u);
    }   
    else
    {
