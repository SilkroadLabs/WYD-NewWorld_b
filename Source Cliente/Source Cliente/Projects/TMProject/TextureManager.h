...
constexpr auto MAX_UI_TEXTURE_SET_LIST = 1024;
constexpr auto MAX_UI_TEXTURE = 1024;
constexpr auto MAX_EFFECT_TEXTURE = 512;
constexpr auto MAX_MODEL_TEXTURE = 4048;
...
public:
	...
	ControlTextureSet m_UITextureSetList[1024];
