...
int BASE_InitializeServerList()
{
    ...
    //Conflict
    //snprintf(g_pServerList[0][0], 64, "https://wydbr.com.br/serv01.htm"); //Link da barra
    //snprintf(g_pServerList[0][1], 64, "51.79.39.230");

    //Morgwyn
    //snprintf(g_pServerList[0][0], 64, "https://wydbr.com.br/serv01.htm"); //Link da barra
    //snprintf(g_pServerList[0][1], 64, "181.215.236.210");

    //Legacy Of War
    snprintf(g_pServerList[0][0], 64, "https://192.168.0.36/serv01.htm"); //Link da barra
    snprintf(g_pServerList[0][1], 64, "192.168.0.36");
